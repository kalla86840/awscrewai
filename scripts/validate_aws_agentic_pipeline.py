...
def main():
    ...
    require("Action: lambda:InvokeFunction" in endpoint_template, "Endpoint stack must allow Lambda invocation through Function URL.")
    require("InvokedViaFunctionUrl: true" in endpoint_template, "Endpoint Lambda invoke permission must be scoped to Function URL calls.")
